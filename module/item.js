...
export class CoDItem extends Item {
    ...
    async roll() {
        ...
        const attributes = actor.sheet.sortAttrGroups();
        const skills = actor.sheet.sortSkillGroups();
        ...
        if (item.type === 'weapon') {
            ...
            this.ShowDialogForNoTarget(dialogData, actor, weaponName, damage);

        }
    }

    ShowDialogForNoTarget(dialogData, actor, weaponName, damage) {
        renderTemplate(
